        ...
        <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16 lg:h-20">
            ...
            <Link to="/" className="flex items-center gap-2.5 group">
              <div className="relative w-9 h-9 rounded-xl bg-gradient-to-br from-kiwi-500 to-kiwi-700 flex items-center justify-center shadow-lg shadow-kiwi-500/20 group-hover:shadow-kiwi-500/40 transition-shadow duration-300">
                <span className="text-dark-950 font-extrabold text-sm tracking-tight">K</span>
            ...
            <div className="hidden lg:flex items-center gap-3">
              <Link
                to="/contact"
                className="group relative inline-flex items-center gap-2 px-5 py-2.5 text-sm font-semibold text-dark-950 bg-gradient-to-r from-kiwi-500 to-kiwi-600 rounded-xl hover:from-kiwi-400 hover:to-kiwi-500 transition-all duration-300 shadow-lg shadow-kiwi-500/20 hover:shadow-kiwi-500/30"
              >
                {t('nav.getStarted')}
            ...
            >
              <div className="flex flex-col pt-24 px-6">
                ...
                >
                  <Link
                    to="/contact"
                    className="flex items-center justify-center gap-2 w-full py-3 text-sm font-semibold text-dark-950 bg-gradient-to-r from-kiwi-500 to-kiwi-600 rounded-xl"
                  >
                    {t('nav.getStarted')}
